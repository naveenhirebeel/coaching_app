...
import { reportMessage, sendTrackedMessage } from '@/lib/telegram'
...
export async function POST(req: NextRequest) {
  ...
  // NOTE: logged as 'alert' (not 'report') to preserve the existing Communications filter behaviour.
  const result = await sendTrackedMessage({ instituteId: user.institute_id, studentId: student_id, batchId: student.batch_id || null, chatId: student.parent_telegram_chat_id, messageType: 'alert', message })
